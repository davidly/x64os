g++ -DX64OS -DNDEBUG -ffunction-sections -fdata-sections -fcf-protection=none -U_FORTIFY_SOURCE -O2 -Wno-psabi -Wno-stringop-overflow -Wno-format-security -fsigned-char -fno-builtin -I . x64os.cxx x64.cxx -o x64os -static -Wl,--gc-sections
